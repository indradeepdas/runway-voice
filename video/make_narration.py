...
SEGMENTS = [
    ...
    ("07_why_aai", "Why AssemblyAI? Universal speech-to-text handles founder-speak: accents, long numbers, unusual company names. Fast turnaround keeps the conversation at the speed of thought. And one API for the whole voice layer lets the product stay focused on the finance model. Next on the roadmap: real-time answers over Universal-Streaming. The intent engine is transport-agnostic, so the same core applies."),
